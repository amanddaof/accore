...
export default function Profile({ onProfileUpdate }) {
  ...
  const [abaAtiva, setAbaAtiva] = useState("configuracoes"); // 👈 nova aba
  ...
  return (
    <div className="page profile-page">
      ...
      <div className="profile-tabs">
        <button
          className={`tab-btn ${abaAtiva === "configuracoes" ? "active" : ""}`}
          onClick={() => setAbaAtiva("configuracoes")}
        >
          ⚙️ Configurações
        </button>
        <button
          className={`tab-btn ${abaAtiva === "comparativo" ? "active" : ""}`}
          onClick={() => setAbaAtiva("comparativo")}
        >
          👥 Comparativo por pessoa
        </button>
      </div>
      ...
      {abaAtiva === "configuracoes" && (
        <>
          {/* Identidade, Avatar, Notificações, Insights, Limites - igual antes */}
      ...
      {abaAtiva === "comparativo" && (
        <section className="profile-section profile-comparativo">
          <MonthComparisonCard />
        </section>
      )}
    </div>
